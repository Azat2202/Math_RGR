...
\begin{flalign*}
	...
	&\sum_{n=1}^\infty \frac{2^n+(-1)^{n+1}}{n(-2)^n} = \sum_{n=1}^\infty \left( \frac{2^n}{n(-1)^n2^n} + \frac{(-1)^{n+1}}{n(-2)^n}\right) = \sum_{n=1}^\infty \frac{(-1)^n}{n}-\sum_{n=1}^\infty \frac{1}{n2^n} &&\\  
	&\text{Получилась разность сходящихся рядов, а значит точка 2,5 входит в область сходимости ряда}&&\\
